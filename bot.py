...
WATER_SCHEDULE = [
    (dtime(7, 0, tzinfo=MSK),
     "☀️ <b>Доброе утро!</b>\nВыпей стакан воды (250 мл) — запускает метаболизм.\n\n<b>Цель на день: 2.2 л</b> (~9 стаканов)"),
    (dtime(9, 0, tzinfo=MSK),
     "💧 <b>Вода</b>\nВыпей стакан. Уже должно быть 2 из 9."),
    (dtime(11, 0, tzinfo=MSK),
     "💧 <b>Вода</b>\nЕщё стакан. К обеду цель — 3-4 стакана."),
    (dtime(13, 0, tzinfo=MSK),
     "🍽 <b>Перед обедом</b>\nВыпей стакан воды за 30 мин до еды — снизит аппетит."),
    (dtime(15, 0, tzinfo=MSK),
     "💧 <b>Вода</b>\nПослеобеденный стакан. Помогает не путать жажду с голодом."),
    (dtime(17, 0, tzinfo=MSK),
     "💧 <b>Вода</b>\nЕщё стакан! Уже должно быть 6-7 из 9."),
    (dtime(19, 0, tzinfo=MSK),
     "💧 <b>Вода</b>\nПоследние стаканы — не откладывай на ночь."),
    (dtime(21, 0, tzinfo=MSK),
     "🌙 <b>Итог дня</b>\nЕсли выпил 8-9 стаканов (2-2.2 л) — отличный результат!\nЗавтра продолжай в том же ритме."),
]
